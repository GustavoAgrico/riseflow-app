...
const ICONS = { LayoutDashboard, GitBranch, Users, ContactRound, Plug, Zap, MessageSquare, BarChart3, Settings, Filter, Megaphone, Calendar, CalendarCheck, UserCog, FileText, ClipboardList, Crown, Bot, Sparkles, Receipt, PhoneCall, Activity }
