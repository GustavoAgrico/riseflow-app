...
export const T = {
  body: 'var(--card)', border: 'var(--border)', text: 'var(--ink-2)', muted: 'var(--ink-3)', dim: 'var(--ink-4)',
  field: '#0B1220', orange: '#FF6B35', green: '#10B981', blue: '#3B82F6', red: '#EF4444', gray: 'var(--ink-4)',
}
