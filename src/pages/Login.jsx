    ...
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: "'DM Sans',sans-serif", background: 'var(--bg)' }}>
      ...
      <div className="rf-l" style={{ width: '50vw', position: 'relative', overflow: 'hidden', background: 'linear-gradient(160deg,#0F172A,#1C1410)', padding: 48, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', textAlign: 'center' }}>
        ...
        <div style={{ position: 'relative' }}>
          <h1 style={{ fontSize: 32, fontWeight: 700, color: 'var(--ink-1)', lineHeight: 1.2, margin: '0 0 16px' }}>Automatize suas plataformas digitais com inteligência artificial</h1>
          <p style={{ fontSize: 16, color: 'var(--ink-3)', margin: '0 0 28px' }}>CRM, chatbot com IA, campanhas em massa e muito mais.</p>
      ...
      <div className="rf-r" style={{ width: '50vw', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
        <div className="rf-c" style={{ width: '100%', maxWidth: 400, background: 'var(--card)', borderRadius: 16, padding: 32, boxShadow: '0 20px 60px rgba(0,0,0,0.3)', animation: 'rfIn .5s ease-out' }}>
          ...
          <h2 style={{ fontSize: 20, fontWeight: 700, color: 'var(--ink-1)', margin: '0 0 4px' }}>Entrar na sua conta</h2>
          <p style={{ fontSize: 14, color: 'var(--ink-3)', margin: '0 0 24px' }}>Bem-vindo de volta!</p>
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: 6, color: 'var(--ink-3)', fontSize: 13, cursor: 'pointer' }}><input type="checkbox" style={{ accentColor: '#FF6B35' }} /> Lembrar de mim</label>
          ...
          <p style={{ textAlign: 'center', fontSize: 14, color: 'var(--ink-3)', marginTop: 20 }}>Não tem conta? <Link to="/register" style={{ color: '#FF6B35', fontWeight: 600, textDecoration: 'none' }}>Criar conta grátis</Link></p>
          <p style={{ textAlign: 'center', marginTop: 10 }}><span onClick={handleDemo} style={{ fontSize: 12, color: 'var(--ink-4)', cursor: 'pointer' }}>Ver demo sem cadastro</span></p>
        </div>
      </div>
    </div>
  )
